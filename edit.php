           ...
           foreach($items as $item){
            ...
            $item['notes'] . "</td>";
               ...
               echo "<a href='uploads/avatars/" . $item['Measure'] ." ' alt=' ' download> <button>تحميل</button></a>";
                 ...
                 echo "</td>";
                echo "<td> <a href='edit.php?do=edit&itemid=" . $item['Item_ID'] . " 'class='btn btn-success'><i class='fa fa-edit'></i> تعديل </a>";
...
function myFunction() {
       ...
       <?php
          ...
          echo '<div class="container">';
             echo '<div class="nice-message">';
              ...
              echo '<a href="newad.php?do=add" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> عقد جديد</a>';
             echo '</div>';
          echo '</div>';
      }
       ?>
 <?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $stmt = $con->prepare ("UPDATE items SET pay1 = ? ,pay2 = ?, pay3 = ?, start = ?,  pstage1 = ?, pstage2 = ?, pstage3 = ?, pstage4 = ? , pstage5 = ? ,
     plot1 = ?, plot2 = ?, plot3 = ?, plot4 = ? , plot5 = ? ,  plot6 = ?, plot7 = ?, plot8 = ?, plot9 = ? , plot10 = ? ,
     plot11 = ?, plot12 = ?, plot13 = ?, plot14 = ? , plot15 = ? , notes = ?  WHERE Item_ID =? ");
    $stmt-> execute(array($pay1, $pay2, $pay3, $start, $pstage1, $pstage2, $pstage3, $pstage4, $pstage5, $plot1, $plot2, $plot3, $plot4, $plot5,
